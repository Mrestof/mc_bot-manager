...
class HomeTab(wx.Panel):
    def __init__(self, parent):
        ...
        base_settings_sizer.Add(chat_mode_title, flag=wx.RIGHT | wx.TOP, border=10)
        base_settings_sizer.Add(self.chat_mode_choice, 1, wx.TOP, 2)
        base_settings_sizer.Add(bot_selector_title, flag=wx.LEFT | wx.RIGHT | wx.TOP, border=10)
        base_settings_sizer.Add(self.bot_selector_choice, 1, wx.TOP, 2)

        main_sizer.Add(base_settings_sizer, flag=wx.EXPAND | wx.LEFT | wx.RIGHT | wx.BOTTOM, border=10)

        # add panel to set detail configurations and to control the state of bots
        ...
        td_bot_sizer.Add(td_bot_title, flag=wx.LEFT | wx.RIGHT, border=10)
        td_bot_sizer.Add(self.td_bot_spin, 1, wx.RIGHT, 10)
        td_iter_sizer.Add(td_iter_title, flag=wx.LEFT | wx.RIGHT, border=10)
        td_iter_sizer.Add(self.td_iter_spin, 1, wx.RIGHT, 10)
        repeats_sizer.Add(repeats_title, flag=wx.LEFT | wx.RIGHT, border=10)
        ...
        # add a text input field to the bottom
